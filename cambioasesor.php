...
<body id="page-top">
        ...
        <div class="col-lg-10 mx-auto">
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="numerocuenta">Numero de Cuenta:(sin -)</label>
                <input type="text" class="form-control" id="numerocuenta" placeholder="Numero de cuenta" maxlength="8" >
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
  <button class="btn btn-primary" id="btn" onclick="actualizarasesor()">Actualizar</button>
</div>
</div>
          <br>
